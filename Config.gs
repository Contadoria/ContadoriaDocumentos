...
var Config_ = (function(config) {
  ...
  config.UI = {
    TITULO: 'Contadoria Documentos',
    FAVICON_URL: 'https://raw.githubusercontent.com/Contadoria/contadoria.github.io/bab78523c78bd27b577d54a034f60d3c0a43cd8c/images/favicon.png'
  };
  ...
  config.STORAGE = {
    ...
    ID: {
      ...
      PASTA_MODELOS: 'PASTA_MODELOS_ID'
    },
    GOOGLE: {
